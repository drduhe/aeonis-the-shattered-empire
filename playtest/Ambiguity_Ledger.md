...
| AL-4 | Packet §3.3 said "Population Pool: 10 (full at start)" even though starting units occupy Population. | **Available Pool = Cap minus the Lord sheet's starting army; Lord units occupy 0.** Default 3 Infantry + 1 Archer starts at 6; most launch Lords start at 7, Rakhis at 6. | `Population.md` §1; `First_Playable_Packet.md` §3.3 | **Resolved** (2026-07-03; synchronized 2026-07-13) |
...
| AL-22 | High Council custom motions / negotiation | Structured negotiation, immediate binding exchanges, and tracked promises are encoded. Bots still propose only revealed agenda cards; free-form custom motions remain outside the simulator. | `High_Council.md` / `Diplomacy.md` | **Open** (custom-motion sim simplification) |
...
| AL-41 | VP threshold for sim pacing experiments (H7 Lever A) | Canon remains **10 VP** (`Victory.md`); sim accepts `config["pacing"]["vp_threshold"]` for PROPOSED sweeps only. Owner accepted **6–8 mean rounds** at 10 VP (2026-07-12); VP12 killed for length alone | `Victory.md` / `sim/` | **Resolved** (sim toggle kept; pacing band accepted 2026-07-12) |
| AL-42 | `frontier_lord` hex threshold (H7 Lever B) | Canon remains **7 hexes** (`Objectives.md`); the 8-hex variant did not fix H7 and remains only as a regression toggle. | `Objectives.md` / `sim/` | **Closed — rejected** (2026-07-03) |
| AL-43 | `seat_of_empire` public VP (seat sweep S1) | First Playable/Full Game card value remains **2 VP**. The simulator's 1-VP S1 balance baseline remains an explicit sim-only calibration and is not a canon rule. | `Objectives.md` / `sim/` | **Closed — sim calibration retained** (2026-07-13) |
| AL-44 | `merchant_lord` gold threshold (early economy E1) | Canon remains **8+ Gold**; the 6-Gold variant regressed economist performance and remains only as a regression toggle. | `Objectives.md` / `sim/` | **Closed — rejected** (2026-07-03) |
| AL-45 | `builder` building threshold (early economy E2) | Canon remains **3 buildings**; the 2-building variant failed its economist gate and remains only as a regression toggle. | `Objectives.md` / `sim/` | **Closed — rejected** (2026-07-03) |
| AL-46 | Tier-1 production build AP (early economy E5) | Canon remains **3 AP** for all standard builds; the 2-AP production-building variant failed its gate and remains only as a regression toggle. | `Actions.md` / `sim/` | **Closed — rejected** (2026-07-03) |
| AL-47 | Staged economy opening (early economy E3) | Canon remains a random opening pair; fixed Builder + Merchant Lord regressed 6p and remains only as a reproducibility toggle. | `Objectives.md` / `sim/` | **Closed — rejected** (2026-07-03) |
