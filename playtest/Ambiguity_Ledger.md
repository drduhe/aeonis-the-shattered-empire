...
| AL-49 | Plan 5 signature behaviors beyond the M4 foundation | Rakhis pre-Pre-Strike retreat and Hit and Run, Seraphel virtual sigils above Tier I, and non-signature passives/actives remain part of the full M4 eight-sheet encode. Canon text is locked; the foundation does not approximate effects whose owning subsystem is not yet encoded. | Core Lord sheets / `sim/` | **Open** (full M4 scope, 2026-07-09) |
