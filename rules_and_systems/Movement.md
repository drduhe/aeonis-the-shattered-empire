...
### Launch-Lord movement exceptions

- **Elyndra — The Deep Roots:** Once per round during her Move action, Elyndra may treat any two Forest hexes she controls as adjacent and move one group between them for 1 AP. The group crosses no intervening hexes; this is not Portal travel.
- **Rakhis — Sandstride:** Rakhis's groups treat Deserts as 1 AP per hex. Once per battle they may retreat before the first Pre-Strike (see Lord sheet / `Combat.md`). They do **not** ignore enemy ZOC surcharges (Dial 3, 2026-07-12; Dial 3b retreat cut reverted).
- **Thal'rik — Dimensional Attunement:** Thal'rik may use Portal travel to enemy-controlled Portals without a treaty or motion.

The owning text and limits remain on the associated Lord sheet.
...
- **Rakhis:** No special ZOC exemption beyond ordinary Cavalry Flanking when the group includes Cavalry (Sandstride ZOC ignore removed 2026-07-12).
