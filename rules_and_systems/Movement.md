...
- **Rakhis — Sandstride:** Rakhis's groups treat Deserts as 1 AP per hex and ignore all enemy ZOC surcharges during Move actions.
...
- **Rakhis exception:** Rakhis's groups ignore the ZOC penalty on every enemy ZOC hex entered during a Move action (see Sandstride above).
