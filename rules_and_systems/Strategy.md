...
- **Primary Ability:** Recruit 2 units for free and deploy them in any controlled hex.
...
- Players can shuffle or rotate available cards to tailor the game’s dynamics.
...
- Instead of selecting cards in initiative order, players can draft cards in reverse Renown order, allowing lower-ranked players to pick first.

### **3. Event-Driven Cards**
