...
- **Starting Population Pool synchronization (2026-07-13):** Lord units occupy **0 Population**. Available setup Pool is Population Cap minus the Population occupied by the Lord sheet's starting army. With cap 10, most launch Lords start at **7 available** (3 occupied); Rakhis and the no-sheet default start at **6 available** (4 occupied). See `Population.md` §1, the Lord sheets, and `../playtest/Ambiguity_Ledger.md` AL-4.
...
- `../pnp/README.md`: generated low-ink First Playable cards, references, maps, and proxy tokens.
