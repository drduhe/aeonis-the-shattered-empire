...
Renown represents the fame and influence of a Lord across the realm. It reflects how well-known and respected (or feared) the Lord is, impacting their ability to sway councils, inspire followers, and intimidate rivals.
...
5. **Event-Driven Opportunities:**
   - Special events might reward Renown for heroic or infamous actions (e.g., saving a town, betraying an ally).
...
## Optional Mechanic: Renown Decay
