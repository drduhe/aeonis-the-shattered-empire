...
- **Lord exceptions:** Elyndra's Deep Roots treats two controlled Forests as adjacent for one group Move per round. (Rakhis Sandstride no longer ignores ZOC — Dial 3, 2026-07-12.) These abilities do not change which units generate ZOC; see `Movement.md` and the Lord sheets.
