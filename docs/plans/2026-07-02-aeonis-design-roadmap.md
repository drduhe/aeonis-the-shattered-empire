...
- **Design review (same day):** six focused improvement plans drafted from the post-burn-down critique — combat aggression, AP economy, VP legibility, 6–8p scaling, core-Lords parity, bookkeeping. See `INDEX.md` for statuses and sequencing.
