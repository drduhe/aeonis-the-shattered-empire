...
- **M7 full-control agents + Lord rotation — DONE** (2026-07-16): independent campaign assignment rotation, every non-forced legal decision under model control, explicit forced-choice accounting, and a zero-cost Portal repetition guard. See [sprint plan](2026-07-16-m7-full-control-and-lord-rotation.md), [rotation campaign](../reports/2026-07-16-m7-six-player-lord-rotation.md), and [full-control smoke](../reports/2026-07-16-m7-six-player-full-control-guarded.md). Findings remain sim-only.
