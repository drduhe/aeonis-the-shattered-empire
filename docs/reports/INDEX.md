...
**Engine:** M3 card systems + full M4 Lord asymmetry (default-on) + audited objectives + validated map geometry + Lever C brakes + S1 seat VP + M5 qualitative agents + M6 conversational negotiation. **363 pytest** passing.
